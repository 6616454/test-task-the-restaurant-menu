...
async def create_menu_in_database(async_session_test: sessionmaker):
...
async def create_submenu_in_database(async_session_test: sessionmaker):
...
@pytest_asyncio.fixture(scope='function')
async def create_dish_in_database(async_session_test: sessionmaker):
...
@pytest_asyncio.fixture(scope='function')
async def delete_menu_from_database(async_session_test: sessionmaker):
...
@pytest_asyncio.fixture(scope='function')
async def delete_submenu_from_database(async_session_test: sessionmaker):
...
@pytest_asyncio.fixture(scope='function')
async def delete_dish_from_database(async_session_test: sessionmaker):
...
@pytest_asyncio.fixture(scope='function')
async def get_menu_from_database(async_session_test: sessionmaker):
...
@pytest_asyncio.fixture(scope='function')
async def get_submenu_from_database(async_session_test: sessionmaker):
...
@pytest_asyncio.fixture(scope='function')
async def get_dish_from_database(async_session_test: sessionmaker):
