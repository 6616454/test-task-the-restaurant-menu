...
class TestDishHandlers:
    ...
    @pytest.mark.parametrize(
        "menu_id, submenu_id, expected_result, status_code",
        [
            (
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize(
        "menu_id, submenu_id, test_data, expected_result, status_code",
        [
            (
                str(uuid.uuid4()),
                str(uuid.uuid4()),
                {"title": "title", "description": "description", "price": "12.49"},
                {"detail": "submenu not found"},
                404,
            ),
            (
            ...
            (
                "b61ec7b4-5b25-41de-9d41-f00331b04885",
                "5f740121-65d6-490b-984c-1cb28a4b43fa",
                {"title": "title", "description": "description", "price": "string"},
    ...
    async def test_invalid_create_dish(
        ...
        await create_submenu_in_database(**submenu_data)
        response = await client.post(
            f"api/v1/menus/{menu_id}/submenus/{submenu_id}/dishes", json=test_data
        )
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize(
        "dish_id, test_data, expected_result, status_code",
        [
            (
            ...
            (
                "911577a1-fbf5-4931-b075-e7641c84121a",
                {"description": "new_description2", "price": "13.50"},
                {
                    "id": "911577a1-fbf5-4931-b075-e7641c84121a",
                    "title": "some_title",
